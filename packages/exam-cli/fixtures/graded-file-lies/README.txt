...
These exact questions could not have existed before block 25962561.

Paper: position 8552, not before block 25962561.
Answers: position 8562, not before block 25962566.
...
To check it: `exam verify <this folder>` (npm: @mikeargento/exam-cli), offline. Or drop the folder on bitgraph.ing.
